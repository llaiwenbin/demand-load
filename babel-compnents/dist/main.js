...
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'jq'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());


function component() {
    const element = document.createElement('div');
    // lodash 在当前 script 中使用 import 引入
    element.innerHTML = lodash__WEBPACK_IMPORTED_MODULE_0__._.join(['Hello', 'webpack'], ' ');
